            ...
            <div className="card card-hover p-8 flex flex-col">
              ...
              <div className="mt-6 flex flex-wrap items-center gap-4">
                ...
                <a
                  ...
                  onClick={() => trackTripleTakeEvent.instagramFollow("homepage")}
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-md ring-1 ring-purple-600/60 text-purple-600 dark:text-purple-400 dark:ring-purple-400/50 hover:bg-purple-600/10 transition-colors font-medium"
